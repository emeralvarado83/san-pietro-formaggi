...
import { getProdotti, SanityProdotto } from '@/lib/sanity'
...
export default async function CatalogoPage() {
  ...
  const byCategory = categories.reduce<Record<string, SanityProdotto[]>>((acc, cat) => {
    ...
    <div>
      ...
      >
        ...
        <p className="text-base max-w-xl mx-auto leading-relaxed" style={{ color: '#2D2D2E', opacity: 0.85 }}>
          Una selezione di formaggi artigianali prodotti con latte locale delle Madonie,
          nel rispetto della tradizione casearia siciliana.
        </p>
      </div>
